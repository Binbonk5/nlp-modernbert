...
CHECKPOINT_DIR = PROJECT_ROOT / "checkpoints" / "sst2_bert_base"
TEST_CSV_PATH = DATA_DIR / "glue-sst2" / "test.csv"

MODEL_NAME = "google-bert/bert-base-uncased"
MODEL_SLUG = MODEL_NAME.replace("/", "_")
RESULTS_FILE = RESULTS_DIR / f"sst2_bert_base_{MODEL_SLUG}.json"
...
def tokenize_split(split, tokenizer):
    ...
    remove_columns = [column for column in split.column_names if column in {"sentence", "idx"}]
    tokenized = split.map(_tokenize, batched=True, remove_columns=remove_columns)
