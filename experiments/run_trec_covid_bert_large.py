...
MODEL_NAME = "sentence-transformers/msmarco-bert-large-dot-v5"
MODEL_SLUG = MODEL_NAME.replace("/", "_")
RESULTS_FILE = RESULTS_DIR / f"trec_covid_bert_large_{MODEL_SLUG}.json"
...
def build_model(model_name: str, device: str):
    transformer = models.Transformer(model_name, model_args={"torch_dtype": torch.float32, "trust_remote_code": True}, tokenizer_args={"use_fast": True})
